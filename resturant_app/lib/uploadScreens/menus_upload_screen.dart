...
class MenusUploadScreen extends StatefulWidget {
  ...
  MenusUploadScreen({super.key, this.menus});
...
class _MenusUploadScreenState extends State<MenusUploadScreen> {
  ...
  void initState() {
    ...
    if (widget.menus != null) {
      isUploadMenu = true;
      isUpdate = true;
      shortInfoController.text = widget.menus!.menuInfo!;
      titleController.text = widget.menus!.menuTitle!;
      thumbnailUrl = widget.menus!.thumbnailUrl!;
      uniqueIdName = widget.menus!.menuId!;
    }
  }
  ...
  menusUploadFormScreen() {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          isUpdate == false ? "Uploading New Menu" : "Updating Menu",
  ...
  Widget build(BuildContext context) {
    return isUploadMenu == false && imageXFile == null ? defaultScreen() : menusUploadFormScreen();
  }
}
